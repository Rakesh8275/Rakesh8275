                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (objJSON.status == 200) {
                            ...
                            window.location.href = '/AJAX/index.php';
                        } else {
                            alert('Something went wrong');
                            window.location.href = '/AJAX/teacherlogin.php';
                        }
                    }
                });
            }
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="#" class="btn btn-primary btn-user btn-block" id="login">
                                            Login
                                        </a><br>
                                        <div class="text-center">
                                    ...
                                    <!-- <div class="text-center">
                                            <a class="small" href="teacherregistration.php">Create an Account!</a>
                                        </div> -->
                                </div>
                            </div>
                        </div>
